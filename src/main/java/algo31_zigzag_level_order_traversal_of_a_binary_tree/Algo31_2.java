package main.java.algo31_zigzag_level_order_traversal_of_a_binary_tree;

import java.util.LinkedList;
import java.util.Queue;
import java.util.Stack;

public class Algo31_2 {
    ...
    public static TreeNode zigzagLevelOrderTraversalOfABinaryTree(TreeNode root){
        ...
        while(!myQueue.isEmpty() || !stack.empty()){
            TreeNode tempNode;
                tempNode = myQueue.poll();
                System.out.println("tempNode.value = " + tempNode.value);
                if(tempNode.leftNode!=null){
                    myQueue.add(tempNode.leftNode);
                    //System.out.println("tempNode.value = " + tempNode.leftNode.value);
                    if(tempNode.leftNode.leftNode!=null){
                        stack.push(tempNode.leftNode.leftNode);
                    }
                    if(tempNode.leftNode.rightNode!=null){
                        stack.push(tempNode.leftNode.rightNode);
                    }
                }
                if(tempNode.rightNode!=null){
                    myQueue.add(tempNode.rightNode);
                    if(tempNode.rightNode.leftNode!=null){
                        stack.push(tempNode.rightNode.leftNode);
                    }
                    if(tempNode.rightNode.rightNode!=null){
                        stack.push(tempNode.rightNode.rightNode);
                    }
                }
            }
        return root;
